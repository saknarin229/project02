...
--
-- Host: localhost
-- Generation Time: Mar 14, 2022 at 06:35 PM
...
INSERT INTO `student_table` (`Std_ID`, `Std_user`, `Std_password`, `Std_firstname`, `Std_lastname`, `Std_sex`, `Std_yearOfStudent`, `Std_image`, `Std_status`) VALUES
(2625, '2625', '2625', 'ด.ช.ชินดนัย', 'ศรีสุข', 'หญิง', '2022-03-14', 'image/Std/2625.jpg', 0),
(2626, '2626', '2626', 'ด.ช.บารมี', 'เกิดรักษ์', 'ชาย', '2022-02-28', NULL, 0),
(2627, '2627', '2627', 'ด.ช.แสงตะวัน', 'นาควงษ์', 'ชาย', '2022-02-28', NULL, 0),
(2629, '2629', '2629', 'ด.ช.พีรพัฒน์', 'บางยับยิ่ง', 'ชาย', '2022-02-28', NULL, 0),
(2631, '2631', '2631', 'ด.ช.ยุทธนา', 'บางยับยิ่ว', 'ชาย', '2022-02-28', NULL, 0),
(2636, '2636', '2636', 'ด.ญ.วิภาวดี', 'พรหมภักดี', 'หญิง', '2022-02-28', NULL, 0),
(2637, '2637', '2637', 'ด.ญ.สุกัญญา', 'เงินพัก', 'หญิง', '2022-02-28', NULL, 0),
(2638, '2638', '2638', 'ด.ญพิมพ์ชนก', 'ปักกะยันตัง', 'หญิง', '2022-02-28', NULL, 0),
(2701, '2701', '2701', 'ด.ญ.ชมัยพร', 'พาพิจิตร', 'หญิง', '2022-02-28', NULL, 0),
(2703, '2703', '2703', 'ด.ช.อดิศร', 'ชัยฤทธิ์', 'ชาย', '0000-00-00', NULL, 0),
(2704, '2704', '2704', 'ด.ญ.กมลวรรณ', 'แซ่ม้า', 'หญิง', '2022-02-28', NULL, 0),
(2767, '2767', '2767', 'ด.ญ.เกศินี', 'นาควงษ์', 'หญิง', '2022-02-28', NULL, 0),
(2795, '2795', '2795', 'ด.ช.สิทธิพงศ์', 'พิศโสภี', 'ชาย', '2022-02-28', NULL, 0),
(2970, '2970', '2970', 'ด.ช.ศิวกร', 'ชนะศึก', 'ชาย', '2022-02-28', NULL, 0),
(2988, '2988', '2988', 'ด.ช.สัญลักษณ์', 'พุ่มด้วง', 'ชาย', '2022-02-28', NULL, 0);
...
CREATE TABLE `studied_result` (
  `sd_id` varchar(10) NOT NULL COMMENT 'รหัสนักเรียน',
  `course_id` varchar(10) NOT NULL COMMENT 'รหัสรายวิชา',
  `gpa` varchar(10) NOT NULL COMMENT 'เกรด',
