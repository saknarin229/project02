...
<section class="container">
    ...
    <div class="col-12 mt-3">
        <?php if($getTeacherData[0]['Tc_picture'] === ""):?>
        ...
        <span>ประจำวิชา : <?php echo $getTeacherData[0]['Tc_department']?></span> <br>
        <span>ตำแหน่ง : <?php echo $getTeacherData[0]['Tc_position']?></span> <br>
